...
function generateBandName() {
  let randNum1 = Math.floor(Math.random() * adj.length);
  let randNum2 = Math.floor(Math.random() * noun.length);

  let randAdj = adj[randNum1];
  let randNoun = noun[randNum2];

  randAdj = randAdj.slice(0, 1).toUpperCase() + randAdj.slice(1, randAdj.length).toLowerCase();
  randNoun = randNoun.slice(0, 1).toUpperCase() + randNoun.slice(1, randNoun.length).toLowerCase();
